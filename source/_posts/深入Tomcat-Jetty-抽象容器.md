...
`ContainerBackgroundProcessor`，`ContainerBase`内部类，实现`Runnable`接口；
...
![JDK-ClassLoader.png](深入Tomcat-Jetty-抽象容器/JDK-ClassLoader.png)
...
![Tomcat-ClassLoader.png](深入Tomcat-Jetty-抽象容器/Tomcat-ClassLoader.png)
